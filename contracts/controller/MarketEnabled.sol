...
contract MarketEnabled is NutzEnabled {
    ...
    uint256 public constant INFINITY = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    ...
    function MarketEnabled(address _pullAddr, address _storageAddr, address _nutzAddr) public
