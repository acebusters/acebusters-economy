...
contract PowerEventReplacement is PowerEvent {
  ...
  // #KEEP ALL THE OTHER PARAMS SAME AS oldPowerEvent except for where *_controllerAddr = _nextControllerAddress, *_discount = 1000000
  function PowerEventReplacement(address _controllerAddr, uint256 _startTime, uint256 _minDuration, uint256 _maxDuration, uint256 _softCap, uint256 _hardCap, uint256 _discount, uint256 _amountPower, address[] _milestoneRecipients, uint256[] _milestoneShares)
